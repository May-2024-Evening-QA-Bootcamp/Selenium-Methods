...
public class HomePage {
	...
	public void click_new_user_registration() {
		try {
			Thread.sleep(4000);
	...
	public void click_incorrect_new_user_registration() {
		try {
			Thread.sleep(4000);
	...
	public void input_text_in_user_id_field () {
		pause(4000);
	...
	public void input_text_in_user_id_and_password_field_then_i_agree_and_click_to_the_loginutton() {
		pause(4000);
	...
	public void use_of_by_class_in_login_process() throws InterruptedException {
		Thread.sleep(4000);
	...
	public void get_methods_of_the_page() {
	...
	public void new_user_registration_page_validation() {
		pause(3000);
	...
	public void mouse_hover_action_on_about_us() {
		...
		List<WebElement> listOfAboutUs = driver.findElements(By.xpath("//a[normalize-space(text())='About Us' and @class='hidden-xs dropdown']//following-sibling::div//child::div//child::div")); // last e single slash dibi next time	
	...
	public void non_skip_home_page_title() {
		String expected = "CMS Enterprise Portal";
		String actual = driver.getTitle();
	...
	public void skip_home_page_title_01() {
		String expected = "CMS Enterprise Portal";
	...
	public void skip_home_page_title_02() {
	...
	public void get_methods_of_the_page_06() {
		String actual = driver.getTitle();
		System.out.println("Title name: "+ actual);
		String expected = "CMS Enterprise Portal";
		Assert.assertEquals(actual, expected, "Home Page Title doesn't match ....... ");		
	...
	public void get_methods_of_the_page_07() {
		String actual = driver.getTitle();
		System.out.println("Title name: "+ actual);
		String expected = "CMS Enterprise Portal";
		Assert.assertEquals(actual, expected, "Home Page Title doesn't match ....... ");	
